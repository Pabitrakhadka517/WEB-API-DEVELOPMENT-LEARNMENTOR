    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <p className="text-blue-400 text-sm font-bold uppercase tracking-widest mb-1">My Students</p>
                    <h1 className="text-4xl font-extrabold text-white mb-2 tracking-tight">Student List</h1>
                    <p className="text-slate-400">Manage and track your active students.</p>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                {[
                    { label: 'Total Students', value: students.length, icon: Users, color: 'from-blue-500 to-indigo-600' },
                    ...
                    { label: 'Total Sessions', value: bookings.length, icon: Calendar, color: 'from-purple-500 to-pink-600' },
                ].map((stat, i) => (
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all"
                />
            </div>
            ...
            {loading ? (
                ...
                <div className="text-center py-20 bg-white/5 border border-white/10 rounded-2xl">
                    ...
                    <p className="text-slate-400">Students will appear here once they book sessions with you.</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {students.map((student) => (
                        <div key={student._id} className="bg-white/5 border border-white/10 rounded-2xl p-5 hover:border-white/20 transition-all group">
                            <div className="flex items-start gap-4 mb-4">
                                <div className="w-12 h-12 rounded-full bg-indigo-500/20 flex items-center justify-center text-indigo-400 font-bold text-lg overflow-hidden shrink-0">
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-4">
                                <div className="bg-white/5 rounded-xl p-3 text-center">
                                    <p className="text-lg font-black text-white">{student.totalSessions}</p>
                                    <p className="text-[10px] text-slate-500 font-bold uppercase">Total Sessions</p>
                                </div>
                                <div className="bg-white/5 rounded-xl p-3 text-center">
                                    <p className="text-lg font-black text-emerald-400">{student.completedSessions}</p>
                            ...
                            <button
                                ...
                                className="w-full py-2.5 bg-indigo-600/10 hover:bg-indigo-600/20 text-indigo-400 border border-indigo-600/20 rounded-xl text-sm font-bold transition-all flex items-center justify-center gap-2"
                            >
